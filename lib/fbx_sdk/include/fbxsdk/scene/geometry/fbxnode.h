...
*****************************************************************************************************************************/
	...
	public:
		...
		#define MACRO_PIVOT_VECTOR_FCTS(name_, defVect) \
			inline const FbxVector4& Get##name_(int id) const \
			{\
				FBX_ASSERT(id == 0 || id == 1); \
				Pivot* p = mPivot[id]; \
			...
			inline void Set##name_(int id, const FbxVector4& pV) \
			{\
				FBX_ASSERT(id == 0 || id == 1); \
		...
		#define MACRO_PIVOT_BOOL_FCTS(name_) \
			inline bool Get##name_(int id) const \
			{\
				FBX_ASSERT(id == 0 || id == 1); \
				Pivot* p = mPivot[id]; \
				if (p == NULL) p = &smDefaultPivot; \
			...
			inline void Set##name_(int id, bool pV) \
			{\
				FBX_ASSERT(id == 0 || id == 1); \
				mIsDefault[id] = false; \
				Get(id).Set##name_(pV); \
