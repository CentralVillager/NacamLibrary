...
void PipelineManager::SetTemplateConfigs() {
	...
	// Object3d_WireFrame
	p_name = PipelineName::Object3d_WireFrame;
	configs_[(int)(p_name)].VS_name = configs_[(int)(PipelineName::Object3d)].VS_name;
	...
	configs_[(int)(p_name)].rtv_formats.resize(2);
	configs_[(int)(p_name)].rtv_formats[0] = configs_[(int)(PipelineName::Object3d)].rtv_formats[0];
	configs_[(int)(p_name)].rtv_formats[1] = configs_[(int)(PipelineName::Object3d)].rtv_formats[1];
	configs_[(int)(p_name)].desc_range.resize(1);
	configs_[(int)(p_name)].desc_range[0].Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1, 0);
	configs_[(int)(p_name)].root_parameter.resize(3);
	configs_[(int)(p_name)].root_parameter[0].InitAsConstantBufferView(0, 0, D3D12_SHADER_VISIBILITY_ALL);
	...
	// IndirectObject3d
	p_name = PipelineName::IndirectObject3d;
	...
	p_name = PipelineName::IndirectObject3d_WireFrame;
	configs_[(int)(p_name)].VS_name = configs_[(int)(PipelineName::IndirectObject3d)].VS_name;
	...
	configs_[(int)(p_name)].rtv_formats.resize(2);
	configs_[(int)(p_name)].rtv_formats[0] = configs_[(int)(PipelineName::IndirectObject3d)].rtv_formats[0];
	configs_[(int)(p_name)].rtv_formats[1] = configs_[(int)(PipelineName::IndirectObject3d)].rtv_formats[1];
	configs_[(int)(p_name)].desc_range.resize(1);
	configs_[(int)(p_name)].desc_range[0].Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1, 0);
	configs_[(int)(p_name)].root_parameter.resize(3);
	configs_[(int)(p_name)].root_parameter[0].InitAsConstantBufferView(0, 0, D3D12_SHADER_VISIBILITY_ALL);
	...
	// PostEffect
	p_name = PipelineName::PostEffect;
	...
	// AverageBlur
	p_name = PipelineName::AverageBlur;
	...
	// GaussianBlur
	p_name = PipelineName::GaussianBlur;
	configs_[(int)(p_name)].VS_name = L"Resources/shaders/BlurVS.hlsl";
